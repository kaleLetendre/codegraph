---
description: Full from-scratch rebuild of this project's codegraph (the correctness backstop)
...
rebuilds THIS project's graph in its own `.codegraph/graph.db`), then reseed state:
